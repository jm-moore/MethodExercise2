...
Console.WriteLine($"If you add {num1}, {num2}, and {num3} you get:");
    Console.WriteLine(Add(num1, num2, num3));

Console.WriteLine($"If you just subtract {num1} and {num2} you get:");
    Console.WriteLine(Subtract(num1, num2));

Console.WriteLine($"If you just multiply {num1} and {num2} you get:");    
    Console.WriteLine(Multiply(num1, num2));

Console.WriteLine($"If you just divide {num1} and {num2} you get;");
    Console.WriteLine(Divide(num1, num2));

Console.WriteLine($"If you just divide {num1} and {num2} you get a remainder of:");
